...
(function () {
    ...
    var DICT = {
        ...
        "tasks.claimFollow": { zh: "去关注", en: "Go Follow" },
        ...
        "admin.taskLink": { zh: "任务链接（点赞/评价/关注任务）", en: "Task Link (Like/Review/Follow Task)" },
        "admin.taskLinkPh": { zh: "https://www.tiktok.com/...", en: "https://www.tiktok.com/..." },
        "admin.taskLinkHint": { zh: "用户领取任务后自动跳转到该链接，完成点赞/评价/关注后截图提交，管理员审核通过即发放佣金。", en: "After claiming, users jump to this link, complete the like/review, submit a screenshot, and get paid once an admin approves." },
