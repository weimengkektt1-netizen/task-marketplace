...
(function () {
    ...
    var DICT = {
        ...
        "member.inviteOrPay": { zh: "邀请 {n} 位好友 或 付费 RM {price} 解锁", en: "Invite {n} friends or pay RM {price} to unlock" },
        "member.payUnlock": { zh: "付费 RM {price} 解锁", en: "Pay RM {price} to unlock" },
        ...
        "tasks.typeShop": { zh: "🛒 商城刷单", en: "🛒 Shop Task" },
        "tasks.claimLike": { zh: "去点赞", en: "Go Like" },
        "tasks.typeReview": { zh: "⭐ 评价任务", en: "⭐ Review Task" },
        "tasks.claimReview": { zh: "去评价", en: "Go Review" },
        ...
        "dash.shopTaskHint": { zh: "刷单任务：领取后请前往 ShopHub 下单购买指定商品，付款审核通过后任务自动完成", en: "Shop task: claim it, then order the product on ShopHub. Once payment is verified, the task completes automatically." },
        ...
        "admin.shopProduct": { zh: "绑定 ShopHub 商品识别码（选填，刷单任务）", en: "Link ShopHub Product Code (optional, shop task)" },
        ...
        "admin.taskTypeShop": { zh: "商城刷单任务", en: "Shop Task" },
        "admin.taskTypeReview": { zh: "评价任务", en: "Review Task" },
        "admin.taskLink": { zh: "任务链接（点赞/评价任务）", en: "Task Link (Like/Review Task)" },
        "admin.taskLinkPh": { zh: "https://www.tiktok.com/...", en: "https://www.tiktok.com/..." },
        "admin.taskLinkHint": { zh: "用户领取任务后自动跳转到该链接，完成点赞/评价后截图提交，管理员审核通过即发放佣金。", en: "After claiming, users jump to this link, complete the like/review, submit a screenshot, and get paid once an admin approves." },
