...
(function () {
    ...
    var DICT = {
        ...
        "member.basic": { zh: "普通会员", en: "Basic" },
        "member.gold": { zh: "黄金会员", en: "Gold" },
        "member.platinum": { zh: "铂金会员", en: "Platinum" },
        "member.diamond": { zh: "钻石会员", en: "Diamond" },
        ...
        "dash.shopTaskGo": { zh: "前往商城完成", en: "Go to Shop" },
        ...
        "admin.shopProduct": { zh: "绑定 ShopHub 商品（选填，刷单任务）", en: "Link ShopHub Product (optional, shop task)" },
        "admin.shopProductPh": { zh: "例如：3", en: "e.g. 3" },
        "admin.shopProductHint": { zh: "填写 ShopHub 商品 ID（商品详情页 #product/ 后面的数字）。填写后该任务为刷单任务：用户领取后跳转商城下单，付款审核通过后任务自动完成并发放佣金。", en: "Enter the ShopHub product ID (the number after #product/ on the product page). Once set, this task becomes a shop task: users order on the shop after claiming, and the task auto-completes with commission when payment is approved." },
